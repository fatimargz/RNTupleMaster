...
During Run 2, the LHC collided protons at a center of mass energy of $\sqrt{s} = 13$ TeV with a combined integrated luminosity of $L = 140.07$ $fb^{-1}$ \cite{Aad_2023}. Beams were delivered in bunches with bunch separation of 25 ns, corresponding to a bunch crossing frequency of 40 MHz. 
...
The ATLAS experiment will also require an upgrade following the HL-LHC. New sub-detectors will be installed such as the Inner Tracker \cite{ATLAS:2017svb}, the High Granularity Timing Detector \cite{2091129}, and additional Muon chambers \cite{2106380}. There will also be different electronics upgrades such as the Liquid Argon Calorimeter \cite{2137108}, the Tile Calorimeter \cite{2137105}, the Muon Spectrometer \cite{Zhu:2019mbl}, and the Trigger and Data Acquisition (TDAQ) system \cite{2137107}. 
