...
\begin{figure}[ht]
\centerline{\includegraphics[width=\textwidth]{ch3_images/datachain.png}}
...
\caption[Data Processes]{The representative diagrams of the processes used in this thesis.}
\label{fig: samples}
\end{figure}
\vspace{2\baselineskip}
...
\vspace{2\baselineskip}
\begin{figure}[H]
\centerline{\includegraphics[width=\textwidth]{ch3_images/TTreeDataStructure.png}}
...
\vspace{2\baselineskip}
\begin{figure}[ht]
\centerline{\includegraphics[width=\textwidth]{ch3_images/TTreevsRNTupleDataStructures.png}}
...
\centerline{\includegraphics[width=.8\textwidth]{ch3_images/ttree.png}}
...
\begin{subfigure}{\linewidth}
\centerline{\includegraphics[width=.8\textwidth]{ch3_images/rntuple.png}}
\caption{Native C++ event loop using RNTuple.}
\label{fig:eventloop-rnt}
\end{subfigure}
\caption[Native C++ Event Loop: TTree vs. RNTuple]{These scripts load a DAOD\_PHYSLITE file containing a TTree in (a) and an RNTuple in (b) to plot the distribution of electron transverse momenta. Transverse momentum is the momentum perpendicular of the colliding beams.}
\end{figure}
\vspace{2\baselineskip}

\subsection{RDataFrame in C++ and Python}
RDataFrame is a high-level interface for analysis of data stored in TTree, RNTuple, CSV, and other data formats. RDataFrame can be used via C++ or Python languages. Analysis done with RDataFrame will mostly remain unmodified with RNTuple, as shown in Figure \ref{fig:rdfpython}, with the exception of filtering. Due to RNTuple's internal data structure, sub fields such as 
...
\begin{subfigure}{\linewidth}
\centerline{\includegraphics[width=0.8\textwidth]{ch3_images/rnt-rdf-python.png}}
...
\begin{figure}[ht]
\begin{subfigure}{\linewidth}
\centerline{\includegraphics[width = 0.8\textwidth]{ch3_images/ttree-rdf.png}}
\caption{Reading multiple TTree inputs.}
\end{subfigure}
...
\begin{subfigure}{\linewidth}
\centerline{\includegraphics[width=0.8\textwidth]{ch3_images/rnt-rdf.png}}
\caption{Reading multiple RNTuple inputs.}
\end{subfigure}
\caption[Applying an RDataFrame Filter in C++ : TTree vs. RNTuple]{Examples of how to load multiple inputs into an RDataFrame and create a new filtered dataframe in C++.}
\label{fig:rdfc}
\end{figure}
\vspace{2\baselineskip}
