...
The peak memory usage when writing out a dataset was also measured for RNTuple and TTree versions. The same procedure using the invariant mass calculation was repeated 100 times, but using the command \texttt{usr/bin/time}. Those measurements are shown in Figure \ref{fig:MemoryInvm}
\begin{figure}
